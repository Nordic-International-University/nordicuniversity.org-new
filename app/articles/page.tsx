...
export const metadata = {
  ...
  description:
    "Nordic Jurnali maqolalar sahifasi, ilmiy, texnologik, va ijtimoiy mavzularda eng so'nggi maqolalarni o'qish uchun tashrif buyuring.",
  keywords: [
    "maqolalar",
    "ilmiy maqolalar",
    "Nordic Jurnali",
  ...
  openGraph: {
    title: "Maqolalar | Nordic Jurnali",
    description:
      "Ilmiy, texnologik, va ijtimoiy mavzularda eng so'nggi maqolalarni Nordic Jurnali orqali o'qish imkoniyati.",
