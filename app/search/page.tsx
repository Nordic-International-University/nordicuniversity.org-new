...
import {
    ...
    useGetSubCategoriesByCategoryIdQuery, useGetAllAuthorQuery,
        ...
        <>
            <Container className="user-select-none">
                ...
                <span className="flex items-center gap-2">
                  <span
                      className="block max-sm:hidden">Topilgan</span> maqolalar soni: <strong>{data?.filterItems}</strong>{" "}
                    ta
                </span>
                            </div>
                                ...
                                {isLoading
                                    ...
                                    data?.data?.map((item: any) => (
                                        <Col key={item.id} xl={12}>
                                            <BigArticlesCard title={item.title}
