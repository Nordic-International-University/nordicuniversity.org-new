...
export const metadata = {
    ...
    description: "Turli maqolalarni turli mezonlar bo‘yicha saralash va qidirish imkoniyatlari.",
    keywords: ["maqolalar", "saralash", "mualliflar", "kategoriyalar", "sana bo‘yicha"],
    openGraph: {
        title: "Maqolalar Saralash",
        description: "Turli maqolalarni turli mezonlar bo‘yicha saralash va qidirish imkoniyatlari.",
