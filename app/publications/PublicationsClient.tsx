            ...
            <div className="flex-col items-center justify-center w-full">
              {volume?.map((item: any, index: number) => (
                <div
                  ...
                  className="w-[900px] max-lg:w-full max-sm:pb-5 max-sm:justify-center flex max-sm:flex-col items-center  shadow-[0.6em_0.6em_1.2em_#d2dce9,-0.5em_-0.5em_1em_#fff] mb-9 mt-6 rounded-3xl "
                >
                  <Image
                    ...
                    height={540}
                    alt="volume"
                    className=" max-sm:h-[340px] max-sm:w-full max-sm:h-auto m-auto block"
                  />
