      ...
      <section className="relative overflow-hidden shadow-inner block max-lg:hidden py-16">
        ...
        <div className="absolute inset-0 bg-tertiary">
          ...
          <div className="absolute inset-0 opacity-[0.07]">
            <svg
              className="absolute -top-1/2 -left-1/4 w-[150%] h-[200%] animate-[spin_120s_linear_infinite]"
              viewBox="0 0 800 800"
            >
              <defs>
                <pattern
                ...
                >
                  ...
                  />
                  <path
                    d="M35 35 Q50 20 65 35 Q80 50 65 65 Q50 80 35 65 Q20 50 35 35"
                    stroke="#3B82F6"
                    strokeWidth="1"
                    fill="none"
                  />
                  {/* Corner ornaments */}
                  <path
                    d="M0 0 Q25 10 25 25 Q10 25 0 0"
                    stroke="#60A5FA"
                    strokeWidth="0.8"
                    fill="none"
                  />
                  <path
                    d="M100 0 Q75 10 75 25 Q90 25 100 0"
                    stroke="#60A5FA"
                    strokeWidth="0.8"
                    fill="none"
                  />
                  <path
                    d="M0 100 Q25 90 25 75 Q10 75 0 100"
                    stroke="#60A5FA"
                    strokeWidth="0.8"
                    fill="none"
                  />
                  <path
                    d="M100 100 Q75 90 75 75 Q90 75 100 100"
                    stroke="#60A5FA"
                    strokeWidth="0.8"
                    fill="none"
                  />
          ...
          <div className="absolute inset-0 opacity-[0.05]">
            <svg
              className="absolute top-0 right-0 w-full h-full animate-[pulse_8s_ease-in-out_infinite]"
              viewBox="0 0 600 600"
            >
              <defs>
                <pattern
                ...
                >
                  ...
                  <polygon
                    points="75,0 90,60 150,75 90,90 75,150 60,90 0,75 60,60"
                    stroke="#3B82F6"
                    strokeWidth="1"
                    fill="none"
                  />
            ...
            <svg className="w-[200%] h-[200%]" viewBox="0 0 400 400">
              <defs>
                ...
                >
                  ...
                  <path
                    d="M40 0 L60 20 L60 60 L40 80 L20 60 L20 20 Z"
                    stroke="#3B82F6"
                    strokeWidth="1"
                    fill="none"
                  />
                  <path
                    d="M0 40 L20 20 M0 40 L20 60 M80 40 L60 20 M80 40 L60 60"
                    stroke="#60A5FA"
                    strokeWidth="0.8"
                    fill="none"
                  />
        ...
        <div className="relative z-10">
          <DoubleSLider
            ...
            sectionTitle={
              sections[SectionTypeEnum.COOPERATION_CONNECTIONS].title
            }
