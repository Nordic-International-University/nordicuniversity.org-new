            ...
            <div className="forms-container overflow-hidden">
                <div className="signin-signup-container">
                    <form onSubmit={handleSignInSubmit}
                        ...
                        <div className="w-[300px]">
                            <Button htmlType="submit" type="primary" loading={isLoggingIn} size="large"
                                    className="w-full mt-5 py-[25px] rounded-3xl" disabled={isLoggingIn}>Kirish</Button>
                        </div>
                    </form>
                    ...
                    <form onSubmit={handleSignUpSubmit}
                        ...
                        <Button htmlType="submit" type="primary"
                                className="rounded-3xl mt-4 py-[22px] max-w-[380px] w-full" loading={isRegistering}
                                disabled={isRegistering}>Ro‘yxatdan o‘tish</Button>
                    </form>
                </div>
            </div>
            ...
            <div className="panels-container">
                <div className="auth-panel max-sm:pt-2 max-sm:px-0 auth-left-panel">
                    <div className="content">
                        ...
                        <p className="max-sm:text-sm text-[20px]">Agar ro'yxatdan o'tmagan bo'lsangiz ro'yxatdan o'tish
                            tugmasini bosing!</p>
                        <Button
                            className="rounded-3xl px-4 mt-4 bg-transparent text-white font-semibold text-lg py-[20px] border-white border-2"
                            id="sign-up-btn" onClick={handleSignUpClick}>Ro‘yxatdan o‘tish</Button>
                    </div>
                ...
                <div className="auth-panel max-sm:pt-2 max-sm:px-0 auth-right-panel">
                    <div className="content">
                        ...
                        <p className="max-sm:text-[15px] text-[20px]">Agar ro'yxatdan o'tgan bo'lsangiz profilingiz
                            mavjud bo'lsa kirish tugmasini bosing!</p>
                        <Button
                            ...
                            id="sign-up-btn" onClick={handleSignInClick}>Kirish</Button>
                    </div>
