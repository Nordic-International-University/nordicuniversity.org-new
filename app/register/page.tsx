...
const Page: React.FC = () => {
    ...
    const handleSignUpSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/sms/check-number`,{
                    ...
                    <div className="signin-signup-container">
                        <form onSubmit={handleSignInSubmit}
                            ...
                            <div className="w-[300px]">
                                <Button htmlType="submit" type="primary" loading={isLoggingIn} size="large"
                                        ...
                                        disabled={isLoggingIn}>Kirish</Button>
                            </div>
                        </form>
                        ...
                        <form onSubmit={handleSignUpSubmit}
                            ...
                            <Button htmlType="submit" type="primary"
                                    className="rounded-3xl mt-4 py-[22px] max-w-[380px] w-full">Ro‘yxatdan
                                o‘tish</Button>
                        </form>
                    </div>
                </div>
                ...
                <div className="panels-container">
                    <div className="auth-panel max-sm:pt-2 max-sm:px-0 auth-left-panel">
                        <div className="content">
                            ...
                            <p className="max-sm:text-sm text-[20px]">Agar ro'yxatdan o'tmagan bo'lsangiz ro'yxatdan
                                o'tish
                                tugmasini bosing!</p>
                            <Button
